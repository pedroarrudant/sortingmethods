...
//efetua a leitura do vetor e o coloca em uma fun��o auxiliar
...
// Troca de valores entre duas posi��es
...
/* Abaixo seguem as fun��es das ordena��es que serao utilizadas
...
main (){
	int v[100],i,n,opcao;
	char opcao2;
	system("cls"); // Limpa a tela para a execu��o dos menus
	printf("Digite a quantidade de numeros desejados: ");
	scanf("%d",&n); // Entrada de dados para o usu�rio
	for(i=0; i<n; i++)
	{
	printf("\nDigite um dos elementos: "); // Entrada de outros dados para o usu�rio
	scanf("%i",&v[i]);}
	le(v,v,n);
	do {//inicia i la�o para o switch
	system("cls");//limpa tela
	printf("\n [1] Bubble \n"); //seleciona Bubble Sort
	printf("\n [2] Selection \n"); // Seleciona Selection Sort
	printf("\n [3] Insert \n"); // Seleciona Insertion Sort
	printf("\n [4] Selection 2 \n")	; // Seleciona a segunda op��o de selection sort
	printf("\n Escolha uma opcao: "); // Abre a op��o do switch para intera��o do usu�rio
	scanf("%d",&opcao);
	switch (opcao){
	case 1: 
	bubbleSort1(v,n);
